...
const RevenueChart = () => {
  ...
  return (
    <motion.div
    className="bg-gray-700 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border
    ...
    >
        <div className="flex justify-between items-center m-6">
            <h2 className="text-xl font-semibold text-gray-200">Revenue Vs Target</h2>
            <select
