...
const ProductsTable = () => {
  ...
  const handleSearch = (e) => {
   ...
   setSeacrhTerm(term);
   const filterd = PRODUCT_DATA.filter(product => product.name.toLowerCase().includes(term) || product.category.toLowerCase()
   .includes(term))
              ...
              {filteredProducts.map(product =>(
                ...
                >
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-100 gap-2 items-center">
                      <img src="https://tse4.mm.bing.net/th?id=OIP.OctJq06i6wIxTXsGBFIx9AHaHa&pid=Api&P=0&h=220 "  
                       alt="Products img"
